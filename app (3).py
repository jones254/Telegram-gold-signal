...
# Local modules (flat layout)
try:
    from auto_refresh import setup_auto_refresh
    import telegram_alerts as tg_alerts
    from telegram_alerts import (
        TelegramConfig as TgConfig,
        _State as TgState,
        AlertHistory,
        is_configured as tg_is_configured,
        send_message as tg_send,
        send_photo as tg_send_photo,
    )
    from signals import (
        SignalConfig, SignalState, SignalResult,
        evaluate as evaluate_signal,
        format_signal_message,
        render_chart_snapshot,
    )
    from data import fetch_multi_timeframe
    from signal_backtest import (
        SignalBacktestConfig, SignalBacktestResult,
        run_signal_backtest,
    )
except ImportError:
    # engine.* package layout fallback
    from engine.auto_refresh import setup_auto_refresh
    import engine.telegram_alerts as tg_alerts
    from engine.telegram_alerts import (
        TelegramConfig as TgConfig,
        _State as TgState,
        AlertHistory,
        is_configured as tg_is_configured,
    ...
    from engine.data import fetch_multi_timeframe
    from engine.signal_backtest import (
        SignalBacktestConfig, SignalBacktestResult,
        run_signal_backtest,
    )
